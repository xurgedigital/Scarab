...
// WHAT TO DO IF INTERRUPTED VA HALL1 EFFECT SENSOR. THIS MEANS THAT A MAGNETIC FIELD WAS DETECTED BY THE HALL1 AND THE VOLTAGE DROPPED TO 0 THUS ACTIVATING THE INTERRUPT WHEN FALLING.
void interrupted()
{
